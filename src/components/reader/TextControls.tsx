  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[var(--ka-blue)] text-white text-sm font-bold shadow-sm hover:bg-[var(--ka-blue-dark)] hover:shadow-md transition-all"
      >
        <Settings2 size={17} />
        Reading Settings
      </button>
