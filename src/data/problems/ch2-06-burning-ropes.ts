...
Lighting a rope from **both ends simultaneously** makes it burn in exactly **half** the time, regardless of density variation.
...
**45 minutes.** Light rope 1 from both ends and rope 2 from one end simultaneously. When rope 1 burns out (30 min), light the other end of rope 2. It burns out 15 min later.`,
