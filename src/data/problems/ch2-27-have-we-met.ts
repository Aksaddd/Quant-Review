...
- At least **3 people are all strangers** to each other.`,
  ...
  solution: `**Proof by Pigeon Hole (Ramsey-type argument):**
...
**Case 1: Person 6 knows at least 3 people — call them A, B, C.**
...
**Case 2: Person 6 does NOT know at least 3 people — call them A, B, C.**
...
**Final Answer:** Proven. Among any 6 people, there must be 3 mutual acquaintances or 3 mutual strangers. This is R(3,3)=6.`,
