...
**Find the 3 fastest horses using the minimum number of races.**`,
  ...
  solution: `**Strategy: Use structured elimination across 3 rounds.**

---

**Round 1 — 5 races:** Divide the 25 horses into 5 groups of 5. Race each group. Label the winner of each group as horses 1, 6, 11, 16, 21 (with groups G1–G5 respectively). The losers (4th, 5th in each group) cannot be top-3 overall.

*After Round 1: 5 group winners identified. (5 races used)*

---

**Round 2 — 1 race:** Race the 5 group winners. Without loss of generality, the order is:
...
**Round 3 — 1 race:** Race horses 2, 3, 6, 7, and 11. The top **2 finishers** are the 2nd and 3rd fastest overall.
